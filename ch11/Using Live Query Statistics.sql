...
-- Section - Using Live Query Statistics
...
SELECT node_id, physical_operator_name, SUM(row_count) AS row_count, 
	SUM(estimate_row_count) AS estimate_row_count, 
	CAST(SUM(row_count)*100 AS float) / 
SUM(estimate_row_count) AS operator_progress 
